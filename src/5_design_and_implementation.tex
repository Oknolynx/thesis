...
\todo{if possible, a screenshot of a corrupted volume in Windows explorer would be great}
...
\todo{privacy:} explain what the other implementations do and that we (could) do the same, but don't do it (yet) because this was not our focus.
