...
Of course, these claims must be verified by an independent party, should certainty be required (i.e. if someone wanted to \texttt{luks2flt} in a production environment).
