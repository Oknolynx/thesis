...
\todo{for performance reasons the initialization of crypto stuff happens when the IOCTL is received},\\
\todo{explain the LUKS2\_CRYPTO\_INFO structure etc?}
...
EncryptWriteBuffer(
	...
	\label{fig:ourapproach.final.encryptwrite}
\end{figure}
