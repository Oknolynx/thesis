...
One situation where a driver needs to access user memory is doing I/O, particularly read or write operations. Because these are so common, the I/O manager presents a solution, namely the \emph{Buffered I/O} and the \emph{Direct I/O} modes \cite{Yosifovich2017}:
\begin{descitemize}
	\item[Buffered I/O] \todo{bla}
	\item[Direct I/O] \todo{MDLs (``a structure that represents information for a buffer in physical memory'', also page 530)}
\end{descitemize}
...
\begin{figure}[htb!]
	...
	\caption[
		...
		Buffered I/O for a read operation (modified after \cite{Yosifovich2017}). \todo{todo}
	}
...
\begin{figure}[htb!]
	...
	\caption[
		...
		Direct I/O (modified after \cite{Yosifovich2017}). \todo{todo}
	}
