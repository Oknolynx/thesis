...
\begin{descitemize}
	...
	\item[\texttt{user}] A key of this type contains a payload of arbitrary binary data (up to 32767 bytes). This data can be accessed and modified from user space.
	\item[\texttt{logon}] \todo{todo}
\end{descitemize}

\todo{explain dm-crypt keyring reference format}
