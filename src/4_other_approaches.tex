...
\autoref{fig:otherapproaches.bitlocker.driverentry} shows that the BitLocker driver filters only IRPs with certain major functions, skipping all other requests. \todo{add screenshot with WinDbg output for \texttt{!drvobj fvevol 7}? or maybe in \autoref{chap:ourapproach.final.genericdispatch}}
