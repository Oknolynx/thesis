...
\paragraph{Interpretation}
\todo{Regrettably, the disabled optimizations led to a performance regression. Check if we can re-enable some options again and increase performance?}
\begin{itemize}
